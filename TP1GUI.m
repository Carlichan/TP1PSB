...
% Last Modified by GUIDE v2.5 28-Aug-2020 19:32:23
...
function valor_media_Callback(hObject, eventdata, handles)
% hObject    handle to valor_media (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of valor_media as text
%        str2double(get(hObject,'String')) returns contents of valor_media as a double


% --- Executes during object creation, after setting all properties.
function valor_media_CreateFcn(hObject, eventdata, handles)
% hObject    handle to valor_media (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
