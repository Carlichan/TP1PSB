classdef FilterOperator
    ...
    methods
         ...
         function signal = lowpassFilter(obj, signal_t, filterType, passband, stopband) % filterType puede ser 'FIR' o 'IIR'
            ...
            if(strcmp(filterType, 'IIR'))
                ...
                Hd = dfilt.dffir(b);
                filtro = Hd.Numerator;
                signal = conv(signal_t, filtro,'same');
            end
        end
                
        function signal = highpassFilter(obj, signal_t, filterType, stopband, passband) % filterType puede ser 'FIR' o 'IIR'
        ...
        function signal = notchFilter(obj, signal_t, filterType, passband1, stopband1, stopband2, passband2) % filterType puede ser 'FIR' o 'IIR'
        ...
        function signal = passbandFilter(obj, signal_t, filterType,stopband1, passband1,passband2, stopband2) % filterType puede ser 'FIR' o 'IIR'
        ...
        function signal = integrateFilter(obj, signal_t) % aca se produce el filtrado del tipo integrador
           % ACA HACER EL FILTRO INTEGRADOR
           Fs = 100000;
           Ts = 1/Fs;
           b = (Ts/2) * [1 1];
           a = [1 -1];
           signal  = filter(b, a, signal_t );
        end 
                
        function signal = derivateFilter(obj, signal_t, n) %aca se produce el filtrado del tipo DERIVADOR
        ...
        function signal = averageFilter(obj, signal_t, n) %aca se produce el filtrado del tipo PROMEDIADOR
